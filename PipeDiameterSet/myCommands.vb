...
Imports Pipe.Commands
' This line is not mandatory, but improves loading performances
<Assembly: CommandClass(GetType(Pipe.MyCommands))> 
Namespace Pipe
    ...
    Public Class MyCommands
        ...
        <CommandMethod("ll", "ll", "ll", CommandFlags.Modal)> _
        Public Sub ll() ' This method can have any name
            ' Put your command code here
            Dim s As New Commands
            s.PipeWithDiameter()

        End Sub
        <CommandMethod("ld", "ld", "ld", CommandFlags.Modal)> _
        Public Sub ld() ' This method can have any name
            ' Put your command code here
            Dim s As New Commands
            s.DiaOverLine()

        End Sub
        <CommandMethod("lo", "lo", "lo", CommandFlags.Modal)> _
        Public Sub lo() ' This method can have any name
            ' Put your command code here
            Dim s As New Commands
            s.PipeWithDiaWithOption()
